...
**************************************************************************************/
//Console.log(y) would return an error because Y has not been defined yet.
//Console.log(x) would return "I'm a local variable" because X has been defined.
...
/*************************************************************************************
------------ ANSWER -------------------
//console.log(x) would return "undefined" because the variable has not been called yet
//console.log(foo) would return "function hoisting" because the the function foo returns "function hoisting"
...
/**************************************************************************************
------------ ANSWER -------------------
The first console.log(add) will return 4 beause it is in the functions local scope.
The second console.log(add) will return an error because it is outside the functions
local  scope and therefore has not yet been defined.
**************************************************************************************/
...
(function(testerTwo){
  "use strict";
  var stringDate = new Date('2017, 6, 21').toDateString();
...
})(new Date('2017, 6, 21').toDateString());
